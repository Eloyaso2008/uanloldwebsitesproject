...
/* harmony import */ var src_app_services_Persona_Persona_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/Persona/Persona.service */ "./src/app/services/Persona/Persona.service.ts");
...
var ClaveAsignarComponent = /** @class */ (function () {
    function ClaveAsignarComponent(SesionSVC, PersonaSVC, snackbar, router) {
        ...
        /* Form */
        this.clave1 = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
        this.clave2 = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(8), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(25)]);
    }
    ...
    ClaveAsignarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_Sesion_Sesion_service__WEBPACK_IMPORTED_MODULE_5__["SesionService"],
            src_app_services_Persona_Persona_service__WEBPACK_IMPORTED_MODULE_4__["PersonaService"],
...
/* harmony import */ var src_app_services_Utils_AngularMaterial_SnackBar_SnackBar_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/Utils/AngularMaterial/SnackBar/SnackBar.service */ "./src/app/services/Utils/AngularMaterial/SnackBar/SnackBar.service.ts");
...
var ClaveRecuperarComponent = /** @class */ (function () {
    ...
    ClaveRecuperarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_Sesion_Sesion_service__WEBPACK_IMPORTED_MODULE_6__["SesionService"],
            src_app_services_Seguridad_Seguridad_service__WEBPACK_IMPORTED_MODULE_5__["SeguridadService"],
            src_app_services_Utils_AngularMaterial_SnackBar_SnackBar_service__WEBPACK_IMPORTED_MODULE_4__["SnackBarService"],
...
var LoginSiaseComponent = /** @class */ (function () {
    ...
    LoginSiaseComponent.prototype.LoginSIASE = function () {
        ...
        if (this.Token) {
            this.SeguridadSVC.IniciarSesionSIASE(this.Token, this.Usuario, this.NombreUsuario).subscribe(function (res) {
                console.log(res);
                if (!res.Error) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.SolicitarRecuperacionPassword = function () {
        ...
        this.SeguridadSVC.SolicitarCambioContrasena(this.DatosRecuperacion).subscribe(function (result) {
            _this.Loading.HideBackdrop();
            if (!result.Code) {
                _this.snackbar.success('Se ha enviado un enlace a tu correo electrónico con los pasos para actualizar tu contraseña', 5000);
            }
            else {
...
/*
     FILE ARCHIVED ON 02:00:50 Feb 28, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:37:49 Apr 13, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 47.967
  LoadShardBlock: 154.715 (3)
  PetaboxLoader3.datanode: 155.173 (5)
  PetaboxLoader3.resolve: 644.191 (3)
  load_resource: 650.469 (2)
*/