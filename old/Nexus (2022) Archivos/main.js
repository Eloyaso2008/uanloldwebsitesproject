            ...
            imports: [
                ...
                _azure_msal_angular__WEBPACK_IMPORTED_MODULE_18__["MsalModule"].forRoot({
                    auth: {
                        ...
                        authority: 'https://web.archive.org/web/20220228020044/https://login.microsoftonline.com/' + _modules_pruebas_MicrosoftGraph_Settings__WEBPACK_IMPORTED_MODULE_19__["OAuthSettings"].tenant,
...
var routes = [
    ...
    {
        path: 'Pruebas',
        loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e(49), __webpack_require__.e(50), __webpack_require__.e(51), __webpack_require__.e(56), __webpack_require__.e(65), __webpack_require__.e("common"), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, /*! ./modules/pruebas/pruebas.module */ "./src/app/modules/pruebas/pruebas.module.ts")).then(function (M) { return M.PruebasModule; }); }
    },
    {
        path: 'AdminGral',
    ...
    {
        path: 'Profesor',
        loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e(48), __webpack_require__.e(49), __webpack_require__.e(50), __webpack_require__.e(52), __webpack_require__.e(54), __webpack_require__.e(82), __webpack_require__.e("common"), __webpack_require__.e(8)]).then(__webpack_require__.bind(null, /*! ./modules/rol/profesor/profesor.module */ "./src/app/modules/rol/profesor/profesor.module.ts")).then(function (M) { return M.ProfesorModule; }); }
    },
    {
        path: 'Estudiante',
        loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e(48), __webpack_require__.e(52), __webpack_require__.e(53), __webpack_require__.e(61), __webpack_require__.e(84), __webpack_require__.e("common"), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, /*! ./modules/rol/estudiante/estudiante.module */ "./src/app/modules/rol/estudiante/estudiante.module.ts")).then(function (M) { return M.EstudianteModule; }); }
    },
];
...
var OAuthSettings = {
    ...
    //LogoutRedirectUri:'https://web.archive.org/web/20220228020044/http://localhost:4200/#/Redireccionando',
    tenant: 'uanl.edu.mx',
    scopes: [
        "user.read",
        "Team.ReadBasic.All",
...
/* harmony import */ var src_app_pipes_safe_html_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/pipes/safe-html.pipe */ "./src/app/pipes/safe-html.pipe.ts");
/* harmony import */ var src_app_pipes_safe_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/pipes/safe-url */ "./src/app/pipes/safe-url.ts");
/* harmony import */ var src_app_pipes_unique_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/pipes/unique.pipe */ "./src/app/pipes/unique.pipe.ts");
...
/* harmony import */ var ngx_pipes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-pipes */ "./node_modules/ngx-pipes/fesm2015/ngx-pipes.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PipesModule = /** @class */ (function () {
    ...
    PipesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                src_app_pipes_safe_html_pipe__WEBPACK_IMPORTED_MODULE_2__["SafeHTMLPipe"],
                src_app_pipes_safe_url__WEBPACK_IMPORTED_MODULE_3__["SafeURLPipe"],
                src_app_pipes_unique_pipe__WEBPACK_IMPORTED_MODULE_4__["UniquePipe"]
            ],
            exports: [
                src_app_pipes_safe_html_pipe__WEBPACK_IMPORTED_MODULE_2__["SafeHTMLPipe"],
                src_app_pipes_safe_url__WEBPACK_IMPORTED_MODULE_3__["SafeURLPipe"],
...
var AvisoService = /** @class */ (function () {
    ...
    AvisoService.prototype.ActualizarAviso = function (Aviso) {
        return this.API.POST(this.Dominio, 'ActualizarAviso', {
            Aviso: Aviso
        });
    };
...
var SeguridadService = /** @class */ (function () {
    ...
    SeguridadService.prototype.IniciarSesionSIASE = function (Token, Usuario, NombreUsuario) {
        var Headers = {
            TokenSIASE: Token,
        };
        if (Usuario)
            Headers['UsuarioSIASE'] = Usuario;
        if (NombreUsuario)
            Headers['NombreUsuarioSIASE'] = NombreUsuario;
        console.log(Token);
...
var UtilsService = /** @class */ (function () {
    ...
    UtilsService.prototype.max = function (data, attr) {
        var max = data.reduce(function (prev, current) { return (prev[attr] > current[attr]) ? prev : current; });
        return max;
    };
...
var TokenInterceptorService = /** @class */ (function () {
    function TokenInterceptorService(SeguridadSVC, SesionSVC, dialog) {
        this.SeguridadSVC = SeguridadSVC;
        this.SesionSVC = SesionSVC;
        this.dialog = dialog;
    ...
    TokenInterceptorService = __decorate([
        ...
        __metadata("design:paramtypes", [_Seguridad_Seguridad_service__WEBPACK_IMPORTED_MODULE_6__["SeguridadService"],
...
var Examen = /** @class */ (function (_super) {
    ...
    function Examen(E) {
        ...
        if (E) {
            ...
            _this.TipoVinculoExamenId = E.TipoVinculoExamenId;
            _this.VinculoExamenId = E.VinculoExamenId;
    ...
    function ExamenReactivoRespuesta(ERR) {
        ...
        if (ERR) {
            ...
            switch (ERR.Reactivo.TipoReactivoId) {
                ...
                //Opcion Multiple
                case 2:
                    this.ReactivoRespuestaOpcionMultiple = ERR.ReactivoRespuestaOpcionMultiple.map(function (R) { return new ExamenReactivoRespuestaOM(R); });
                    break;
                //Respuesta Multiple
                case 3:
...
var TextEditor = /** @class */ (function () {
    ...
    TextEditor.prototype.CleanFroalaEditor = function (HTML) {
        var Descripcion;
        if (HTML) {
            Descripcion = HTML.replace('<p data-f-id="pbf" style="text-align: center; font-size: 14px; margin-top: 30px; opacity: 0.65; font-family: sans-serif;">Powered by <a href="https://web.archive.org/web/20220228020044/https://www.froala.com/wysiwyg-editor?pb=1" title="Froala Editor">Froala Editor</a></p>', '');
        }
        return Descripcion;
    };
    return TextEditor;
...
var CONSTANTS = /** @class */ (function () {
    ...
    CONSTANTS.URLVideotutoriales = 'https://web.archive.org/web/20220228020044/https://www.youtube.com/embed/';
    CONSTANTS.Textos = {
        Error: {
    ...
    CONSTANTS.MODALIDADES = [
        { ModalidadId: 1, Descripcion: "Presencial" },
        { ModalidadId: 2, Descripcion: "A Distancia" },
        { ModalidadId: 3, Descripcion: "Abierto" },
        { ModalidadId: 4, Descripcion: "Mixto" },
    ];
    /* SIASE */
    ...
    CONSTANTS.CURSO_IMAGENES = [
        ...
        { CursoId: 214230, ImagenId: 2, Image: "https://web.archive.org/web/20220228020044/https://cdn.kastatic.org/googleusercontent/pmSFOg8sp5pAK3K1oP7KAB3bckl1uYej2PfZtGQI3LDQ4jsLzkMhDNfEA6bxiUUGFt2aQUgwwKhPINWpzy5F7sD0" },
        { CursoId: 224242, ImagenId: 3, Image: "https://web.archive.org/web/20220228020044/https://image.slidesharecdn.com/electricidadymagnetismo1-130709192314-phpapp01/95/electricidad-y-magnetismo-1-1-638.jpg?cb=1373397855" },
        { CursoId: 214231, ImagenId: 4, Image: "https://web.archive.org/web/20220228020044/https://www.definicionabc.com/wp-content/uploads/estadistica.jpg" },
        { CursoId: 214232, ImagenId: 5, Image: "https://web.archive.org/web/20220228020044/http://www.die.uma.es/archivos/electromagnetismo2.jpg" },
        { CursoId: 214233, ImagenId: 6, Image: "https://web.archive.org/web/20220228020044/https://cdn.pruebat.org/recursos/recursos/matematicas.png" },
...
var GeneralService = /** @class */ (function () {
    ...
    GeneralService.prototype.getImageCurso = function (C) {
        var images = [
            { CursoId: null, Image: "https://web.archive.org/web/20220228020044/https://image.posta.com.mx/sites/default/files/sdxcv.jpg" },
            { CursoId: 214230, Image: "https://web.archive.org/web/20220228020044/https://cdn.kastatic.org/googleusercontent/pmSFOg8sp5pAK3K1oP7KAB3bckl1uYej2PfZtGQI3LDQ4jsLzkMhDNfEA6bxiUUGFt2aQUgwwKhPINWpzy5F7sD0" },
            { CursoId: 224242, Image: "https://web.archive.org/web/20220228020044/https://image.slidesharecdn.com/electricidadymagnetismo1-130709192314-phpapp01/95/electricidad-y-magnetismo-1-1-638.jpg?cb=1373397855" },
            { CursoId: 214231, Image: "https://web.archive.org/web/20220228020044/https://www.definicionabc.com/wp-content/uploads/estadistica.jpg" },
            { CursoId: 214232, Image: "https://web.archive.org/web/20220228020044/http://www.die.uma.es/archivos/electromagnetismo2.jpg" },
            { CursoId: 214233, Image: "https://web.archive.org/web/20220228020044/https://cdn.pruebat.org/recursos/recursos/matematicas.png" },
...
module.exports = __webpack_require__(/*! C:\Users\rene.cardonam\Documents\UANL\Nexus\Nexus 7\SourceCode\Nexus7-UI\src\main.ts */"./src/main.ts");
...
/*
     FILE ARCHIVED ON 02:00:44 Feb 28, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:37:21 Apr 13, 2025.
...
playback timings (ms):
  ...
  esindex: 0.015
  cdx.remote: 14.852
  LoadShardBlock: 182.487 (3)
  PetaboxLoader3.datanode: 79.313 (4)
  PetaboxLoader3.resolve: 161.729 (2)
  load_resource: 125.801
*/