...
var GrupoSIASE = /** @class */ (function () {
    function GrupoSIASE(G) {
        ...
        this.CursoCompartido = G.CursoCompartido;
        this.Curso = G.Curso;
        this.EnConflicto = G.EnConflicto;
        this.Estado = G.Estado;
        this.GCarrera = G.Carrera;
        this.CursoCompartidoIndicador = G.CursoCompartidoIndicador;
    }
...
var AvisosService = /** @class */ (function () {
    ...
    AvisosService.prototype.UpdateAviso = function (_Aviso) {
        var _this = this;
        var data = { Aviso: _Aviso };
        this.updateHeader();
        return this.http.post(_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].API_ENDPOINT + "Aviso/ActualizarAviso", data, this.HEADER)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) { return _this.general_service.handleResult(data); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) { return _this.general_service.handleError(error); }));
    };
...
/*
     ...
     INTERNET ARCHIVE ON 22:37:48 Apr 13, 2025.
...
playback timings (ms):
  ...
  esindex: 0.015
  cdx.remote: 13.626
  LoadShardBlock: 89.916 (3)
  PetaboxLoader3.datanode: 86.901 (5)
  PetaboxLoader3.resolve: 280.438 (3)
  load_resource: 318.194 (2)
*/