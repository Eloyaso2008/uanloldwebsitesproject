    ...
    if (http.readyState == 4) {
       if (http.status == 200) {
        ...
        //  Aqui para ver los Labes cadena  alert(cadenaIdsLabels);
		    ...
		    {
		        if (resultsIds[i] == "ContentPlaceHolder2_btnEntrar")
		        {
...
/*
     FILE ARCHIVED ON 04:00:27 Nov 25, 2015 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.016
  cdx.remote: 45.953
  LoadShardBlock: 239.64 (3)
  PetaboxLoader3.datanode: 213.806 (4)
