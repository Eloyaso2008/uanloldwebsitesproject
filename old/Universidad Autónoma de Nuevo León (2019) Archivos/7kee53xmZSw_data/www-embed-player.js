...
hf("//web.archive.org/web/20190908183245/https://static.doubleclick.net/instream/ad_status.js",a);uf.push(qf(function(){vf||"google_ad_status"in window||(of("//web.archive.org/web/20190908183245/https://static.doubleclick.net/instream/ad_status.js",a),vf=!0,O("DCLKSTAT",3))},5E3))}}
...
b=Be("//web.archive.org/web/20190908183245/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof vd&&b.abort();
return sd(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//web.archive.org/web/20190908183245/https://static.doubleclick.net/instream/ad_status.js");vf=!1;O("DCLKSTAT",0);Vc(Wi,Vi);if(a=Ui)a.removeEventListener("onScreenChanged",Zi),a.removeEventListener("onLogClientVeCreated",Yi),a.removeEventListener("onLogServerVeCreated",$i),a.removeEventListener("onLogVeClicked",aj),a.removeEventListener("onLogVesShown",bj),a.destroy();Xi={}});
...
/*
     FILE ARCHIVED ON 18:32:45 Sep 08, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 03:55:31 Apr 13, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 13.595
  LoadShardBlock: 115.133 (6)
  PetaboxLoader3.datanode: 144.876 (8)
  load_resource: 195.206 (2)
  PetaboxLoader3.resolve: 126.776 (2)
*/